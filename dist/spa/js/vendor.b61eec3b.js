(self["webpackChunkgoaldetectionmini_app"] = self["webpackChunkgoaldetectionmini_app"] || []).push([[736],{
...
/* harmony default export */ const QSpinner = ((0,create/* createComponent */.L)({
  name: 'QSpinner',
...
// EXTERNAL MODULE: ./node_modules/quasar/src/composables/private/use-router-link.js
var use_router_link = __webpack_require__(7277);
...
const useBtnProps = { ...use_size/* useSizeProps */.LU,
  ...use_router_link/* useRouterLinkProps */.$,
  type: {
    type: String,
    default: 'button'
  },
...
let touchTarget = null,
    keyboardTarget = null,
    mouseTarget = null;
/* harmony default export */ const QBtn = ((0,create/* createComponent */.L)({
  name: 'QBtn',
  props: { ...useBtnProps,
    percentage: Number,
  ...
  setup(props, {
    ...
    const ripple = (0,reactivity_esm_bundler/* computed */.Fl)(() => props.disable === true || props.ripple === false ? false : {
      keyCodes: isLink.value === true ? [13, 32] : [13],
      ...(props.ripple === true ? {} : props.ripple)
    });
    const rippleProps = (0,reactivity_esm_bundler/* computed */.Fl)(() => ({
      center: props.round
    }));
    ...
    return () => {
      ...
      return (0,runtime_core_esm_bundler/* withDirectives */.wy)((0,runtime_core_esm_bundler.h)(isLink.value === true ? 'a' : 'button', nodeProps.value, child), [[Ripple, ripple.value, void 0, rippleProps.value]]);
    };
  }
...
;// CONCATENATED MODULE: ./node_modules/quasar/src/composables/private/use-history.js


/* harmony default export */ function use_history(showing, hide, hideOnRouteChange) {
  let historyEntry;

  function removeFromHistory() {
    if (historyEntry !== void 0) {
      src_history/* default.remove */.Z.remove(historyEntry);
      historyEntry = void 0;
    }
  }
  ...
  return {
    ...
    addToHistory() {
      ...
      src_history/* default.add */.Z.add(historyEntry);
    }

  };
}
// EXTERNAL MODULE: ./node_modules/quasar/src/utils/private/vm.js
var private_vm = __webpack_require__(7445);
;// CONCATENATED MODULE: ./node_modules/quasar/src/composables/private/use-model-toggle.js
...
const useModelToggleEmits = ['before-show', 'show', 'before-hide', 'hide']; // handleShow/handleHide -> removeTick(), self (& emit show), prepareTick()

/* harmony default export */ function use_model_toggle({
  showing,
  canShow,
  // optional
  hideOnRouteChange,
  ...
  (0,runtime_core_esm_bundler/* watch */.YP)(() => props.modelValue, processModelChange);

  if (hideOnRouteChange !== void 0 && (0,private_vm/* vmHasRouter */.Rb)(vm) === true) {
    (0,runtime_core_esm_bundler/* watch */.YP)(() => proxy.$route, () => {
  ...
  processOnMount === true && (0,runtime_core_esm_bundler/* onMounted */.bv)(() => {
...
;// CONCATENATED MODULE: ./node_modules/quasar/src/utils/prevent-scroll.js
...
function shouldPreventScroll(e) {
  ...
  const path = (0,utils_event/* getEventPath */.AZ)(e),
  ...
  for (let index = 0; index < path.length; index++) {
    ...
    if ((0,utils_scroll/* hasScrollbar */.QA)(el, scrollY)) {
...
function apply(action) {
  ...
  if (action === 'add') {
    ...
    scrollPositionX = (0,utils_scroll/* getHorizontalScrollPosition */.OI)(window);
    scrollPositionY = (0,utils_scroll/* getVerticalScrollPosition */.u3)(window);
    ...
    if (Platform/* client.is.ios */.Lp.is.ios === true) {
      if (hasViewport === true) {
        window.scrollTo(0, 0);
        window.visualViewport.addEventListener('resize', onAppleResize, utils_event/* listenOpts.passiveCapture */.rU.passiveCapture);
        window.visualViewport.addEventListener('scroll', onAppleResize, utils_event/* listenOpts.passiveCapture */.rU.passiveCapture);
        window.scrollTo(0, 0);
      } else {
        window.addEventListener('scroll', onAppleScroll, utils_event/* listenOpts.passiveCapture */.rU.passiveCapture);
      }
    }
  }

  if (Platform/* client.is.desktop */.Lp.is.desktop === true && Platform/* client.is.mac */.Lp.is.mac === true) {
    // ref. https://developers.google.com/web/updates/2017/01/scrolling-intervention
    window[`${action}EventListener`]('wheel', onWheel, utils_event/* listenOpts.notPassive */.rU.notPassive);
  }

  if (action === 'remove') {
    if (Platform/* client.is.ios */.Lp.is.ios === true) {
      if (hasViewport === true) {
        window.visualViewport.removeEventListener('resize', onAppleResize, utils_event/* listenOpts.passiveCapture */.rU.passiveCapture);
        window.visualViewport.removeEventListener('scroll', onAppleResize, utils_event/* listenOpts.passiveCapture */.rU.passiveCapture);
      } else {
        window.removeEventListener('scroll', onAppleScroll, utils_event/* listenOpts.passiveCapture */.rU.passiveCapture);
      }
    }
...
/* harmony default export */ function prevent_scroll(state) {
  ...
  if (state === true) {
    ...
    if (Platform/* client.is.ios */.Lp.is.ios === true && Platform/* client.is.nativeMobile */.Lp.is.nativeMobile === true) {
      clearTimeout(closeTimer);
...
;// CONCATENATED MODULE: ./node_modules/quasar/src/composables/private/use-prevent-scroll.js
...
;// CONCATENATED MODULE: ./node_modules/quasar/src/composables/private/use-timeout.js

/* harmony default export */ function use_timeout() {
  let timer;
  (0,runtime_core_esm_bundler/* onBeforeUnmount */.Jd)(() => {
    clearTimeout(timer);
  });
...
// EXTERNAL MODULE: ./node_modules/quasar/src/utils/private/create.js
var create = __webpack_require__(908);
;// CONCATENATED MODULE: ./node_modules/quasar/src/utils/private/touch.js
...
;// CONCATENATED MODULE: ./node_modules/quasar/src/utils/private/selection.js
...
function clearSelection() {
  if (window.getSelection !== void 0) {
    ...
    if (selection.empty !== void 0) {
      ...
      Platform/* default.is.mobile */.ZP.is.mobile !== true && selection.addRange(document.createRange());
    }
...
/* harmony default export */ const TouchPan = ((0,create/* createDirective */.f)( false ? 0 : {
  ...
  beforeMount(el, {
    ...
    const ctx = {
      ...
      mouseStart(evt) {
        if (shouldStart(evt, ctx) && (0,utils_event/* leftClick */.du)(evt)) {
...
/* harmony default export */ const QDrawer = ((0,create/* createComponent */.L)({
  ...
  setup(props, {
    ...
    const isMini = (0,reactivity_esm_bundler/* computed */.Fl)(() => props.mini === true && belowBreakpoint.value !== true);
    const size = (0,reactivity_esm_bundler/* computed */.Fl)(() => isMini.value === true ? props.miniWidth : props.width);
    ...
    const hideOnRouteChange = (0,reactivity_esm_bundler/* computed */.Fl)(() => props.persistent !== true && (belowBreakpoint.value === true || onScreenOverlay.value === true));
    ...
    const {
      addToHistory,
      removeFromHistory
    } = use_history(showing, hide, hideOnRouteChange);
    const instance = {
      belowBreakpoint,
      hide
    };
    const rightSide = (0,reactivity_esm_bundler/* computed */.Fl)(() => props.side === 'right');
    const stateDirection = (0,reactivity_esm_bundler/* computed */.Fl)(() => ($q.lang.rtl === true ? -1 : 1) * (rightSide.value === true ? 1 : -1));
    ...
    const otherSide = (0,reactivity_esm_bundler/* computed */.Fl)(() => rightSide.value === true ? 'left' : 'right');
    const offset = (0,reactivity_esm_bundler/* computed */.Fl)(() => showing.value === true && belowBreakpoint.value === false && props.overlay === false ? props.miniToOverlay === true ? props.miniWidth : size.value : 0);
    const fixed = (0,reactivity_esm_bundler/* computed */.Fl)(() => props.overlay === true || props.miniToOverlay === true || $layout.view.value.indexOf(rightSide.value ? 'R' : 'L') > -1 || $q.platform.is.ios === true && $layout.isContainer.value === true);
    const onLayout = (0,reactivity_esm_bundler/* computed */.Fl)(() => props.overlay === false && showing.value === true && belowBreakpoint.value === false);
    const onScreenOverlay = (0,reactivity_esm_bundler/* computed */.Fl)(() => props.overlay === true && showing.value === true && belowBreakpoint.value === false);
    const backdropClass = (0,reactivity_esm_bundler/* computed */.Fl)(() => 'fullscreen q-drawer__backdrop' + (showing.value === false && flagPanning.value === false ? ' hidden' : ''));
    const backdropStyle = (0,reactivity_esm_bundler/* computed */.Fl)(() => ({
      backgroundColor: `rgba(0,0,0,${flagBackdropBg.value * 0.4})`
    }));
    const headerSlot = (0,reactivity_esm_bundler/* computed */.Fl)(() => rightSide.value === true ? $layout.rows.value.top[2] === 'r' : $layout.rows.value.top[0] === 'l');
    const footerSlot = (0,reactivity_esm_bundler/* computed */.Fl)(() => rightSide.value === true ? $layout.rows.value.bottom[2] === 'r' : $layout.rows.value.bottom[0] === 'l');
    const aboveStyle = (0,reactivity_esm_bundler/* computed */.Fl)(() => {
      const css = {};
    ...
    const contentClass = (0,reactivity_esm_bundler/* computed */.Fl)(() => 'q-drawer__content fit ' + ($layout.isContainer.value !== true ? 'scroll' : 'overflow-auto'));
    const classes = (0,reactivity_esm_bundler/* computed */.Fl)(() => `q-drawer q-drawer--${props.side}` + (flagMiniAnimate.value === true ? ' q-drawer--mini-animate' : '') + (props.bordered === true ? ' q-drawer--bordered' : '') + (isDark.value === true ? ' q-drawer--dark q-dark' : '') + (flagPanning.value === true ? ' no-transition' : showing.value === true ? '' : ' q-layout--prevent-focus') + (belowBreakpoint.value === true ? ' fixed q-drawer--on-top q-drawer--mobile q-drawer--top-padding' : ` q-drawer--${isMini.value === true ? 'mini' : 'standard'}` + (fixed.value === true || onLayout.value !== true ? ' fixed' : '') + (props.overlay === true || props.miniToOverlay === true ? ' q-drawer--on-top' : '') + (headerSlot.value === true ? ' q-drawer--top-padding' : '')));
    const openDirective = (0,reactivity_esm_bundler/* computed */.Fl)(() => {
    ...
    const contentCloseDirective = (0,reactivity_esm_bundler/* computed */.Fl)(() => {
    ...
    const backdropCloseDirective = (0,reactivity_esm_bundler/* computed */.Fl)(() => {
    ...
    (0,runtime_core_esm_bundler/* watch */.YP)($layout.totalWidth, val => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_utils_private_create_js__WEBPACK_IMPORTED_MODULE_1__/* .createComponent */ .L)({
  ...
  setup(props, {
    ...
    const fixed = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => props.reveal === true || $layout.view.value.indexOf('H') > -1 || $layout.isContainer.value === true);
    const offset = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => {
      if (props.modelValue !== true) {
        return 0;
      }
    ...
    const hidden = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => props.modelValue !== true || fixed.value === true && revealed.value !== true);
    const revealOnFocus = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => props.modelValue === true && hidden.value === true && props.reveal === true);
    const classes = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => 'q-header q-layout__section--marginal ' + (fixed.value === true ? 'fixed' : 'absolute') + '-top' + (props.bordered === true ? ' q-header--bordered' : '') + (hidden.value === true ? ' q-header--hidden' : '') + (props.modelValue !== true ? ' q-layout--prevent-focus' : ''));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_utils_private_create_js__WEBPACK_IMPORTED_MODULE_2__/* .createComponent */ .L)({
  ...
  setup(props, {
    ...
    const classes = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => 'q-icon' + (props.left === true ? ' on-left' : '') + (props.right === true ? ' on-right' : '') + (props.color !== void 0 ? ` text-${props.color}` : ''));
    const type = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => {
      let cls;
      let icon = props.name;
    ...
    return () => {
      ...
      if (type.value.none === true) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_3__.h)(props.tag, data, (0,_utils_private_render_js__WEBPACK_IMPORTED_MODULE_5__/* .hSlot */ .KR)(slots.default));
      }

      if (type.value.img === true) {
        data.src = type.value.src;
        return (0,vue__WEBPACK_IMPORTED_MODULE_3__.h)('img', data);
      }

      if (type.value.svg === true) {
        data.viewBox = type.value.viewBox;
        return (0,vue__WEBPACK_IMPORTED_MODULE_3__.h)('svg', data, (0,_utils_private_render_js__WEBPACK_IMPORTED_MODULE_5__/* .hMergeSlot */ .vs)(slots.default, type.value.nodes));
      }

      if (type.value.svguse === true) {
        data.viewBox = type.value.viewBox;
        return (0,vue__WEBPACK_IMPORTED_MODULE_3__.h)('svg', data, (0,_utils_private_render_js__WEBPACK_IMPORTED_MODULE_5__/* .hMergeSlot */ .vs)(slots.default, [(0,vue__WEBPACK_IMPORTED_MODULE_3__.h)('use', {
          'xlink:href': type.value.src
        })]));
      }

      return (0,vue__WEBPACK_IMPORTED_MODULE_3__.h)(props.tag, data, (0,_utils_private_render_js__WEBPACK_IMPORTED_MODULE_5__/* .hMergeSlot */ .vs)(slots.default, [type.value.content]));
    };
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_utils_private_create_js__WEBPACK_IMPORTED_MODULE_3__/* .createComponent */ .L)({
  ...
  setup(props, {
    ...
    const isActionable = (0,vue__WEBPACK_IMPORTED_MODULE_5__/* .computed */ .Fl)(() => props.clickable === true || hasLink.value === true || props.tag === 'a' || props.tag === 'label');
    const isClickable = (0,vue__WEBPACK_IMPORTED_MODULE_5__/* .computed */ .Fl)(() => props.disable !== true && isActionable.value === true);
    const classes = (0,vue__WEBPACK_IMPORTED_MODULE_5__/* .computed */ .Fl)(() => 'q-item q-item-type row no-wrap' + (props.dense === true ? ' q-item--dense' : '') + (isDark.value === true ? ' q-item--dark' : '') + (hasLink.value === true ? linkClass.value : props.active === true ? `${props.activeClass !== void 0 ? ` ${props.activeClass}` : ''} q-item--active` : '') + (props.disable === true ? ' disabled' : '') + (isClickable.value === true ? ' q-item--clickable q-link cursor-pointer ' + (props.manualFocus === true ? 'q-manual-focusable' : 'q-focusable q-hoverable') + (props.focused === true ? ' q-manual-focusable--focused' : '') : ''));
    const style = (0,vue__WEBPACK_IMPORTED_MODULE_5__/* .computed */ .Fl)(() => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_utils_private_create_js__WEBPACK_IMPORTED_MODULE_1__/* .createComponent */ .L)({
  ...
  setup(props, {
    ...
    const classes = (0,vue__WEBPACK_IMPORTED_MODULE_3__/* .computed */ .Fl)(() => 'q-list' + (props.bordered === true ? ' q-list--bordered' : '') + (props.dense === true ? ' q-list--dense' : '') + (props.separator === true ? ' q-list--separator' : '') + (isDark.value === true ? ' q-list--dark' : '') + (props.padding === true ? ' q-list--padding' : ''));
    return () => (0,vue__WEBPACK_IMPORTED_MODULE_2__.h)('div', {
      class: classes.value
...
/* harmony default export */ const QLayout = ((0,create/* createComponent */.L)({
  ...
  setup(props, {
    ...
    const classes = (0,reactivity_esm_bundler/* computed */.Fl)(() => 'q-layout q-layout--' + (props.container === true ? 'containerized' : 'standard'));
    const style = (0,reactivity_esm_bundler/* computed */.Fl)(() => props.container === false ? {
      minHeight: $q.screen.height + 'px'
    } : null); // used by container only

    const targetStyle = (0,reactivity_esm_bundler/* computed */.Fl)(() => scrollbarWidth.value !== 0 ? {
      [$q.lang.rtl === true ? 'left' : 'right']: `${scrollbarWidth.value}px`
    } : null);
    const targetChildStyle = (0,reactivity_esm_bundler/* computed */.Fl)(() => scrollbarWidth.value !== 0 ? {
    ...
    const $layout = {
      instances: {},
      view: (0,reactivity_esm_bundler/* computed */.Fl)(() => props.view),
      isContainer: (0,reactivity_esm_bundler/* computed */.Fl)(() => props.container),
      rootRef,
      height,
      containerHeight,
      scrollbarWidth,
      totalWidth: (0,reactivity_esm_bundler/* computed */.Fl)(() => width.value + scrollbarWidth.value),
      rows: (0,reactivity_esm_bundler/* computed */.Fl)(() => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_utils_private_create_js__WEBPACK_IMPORTED_MODULE_0__/* .createComponent */ .L)({
  ...
  setup(props, {
    ...
    const classes = (0,vue__WEBPACK_IMPORTED_MODULE_3__/* .computed */ .Fl)(() => `q-page ${props.padding === true ? ' q-layout-padding' : ''}`);
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  ...
  const hasLinkConfigured = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => hasRouter === true && props.disable !== true && props.to !== void 0 && props.to !== null && props.to !== '');
  const linkRoute = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => {
  ...
  const hasLink = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => linkRoute.value !== null);
  const linkTag = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => hasLink.value === true ? 'a' : props.tag || 'div');
  const linkActiveIndex = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => {
  ...
  const linkIsActive = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => hasLink.value === true && linkActiveIndex.value > -1 && includesParams(proxy.$route.params, linkRoute.value.params));
  const linkIsExactActive = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => linkIsActive.value === true && linkActiveIndex.value === proxy.$route.matched.length - 1 && isSameRouteLocationParams(proxy.$route.params, linkRoute.value.params));
  const linkClass = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => hasLink.value === true ? linkIsExactActive.value === true ? ` ${props.exactActiveClass} ${props.activeClass}` : props.exact === true ? '' : linkIsActive.value === true ? ` ${props.activeClass}` : '' : '');
  const linkProps = (0,vue__WEBPACK_IMPORTED_MODULE_4__/* .computed */ .Fl)(() => hasLink.value === true ? {
...
/* harmony export */ });
/* unused harmony export hMergeSlotSafely */
...
/* harmony export */ });
/* unused harmony exports getParentVm, getNormalizedVNodes */
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(71);
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_0__);
...
const autoInstalledPlugins = [Platform/* default */.ZP, body, Dark, Screen, src_history/* default */.Z, lang, icon_set];
...
//# sourceMappingURL=vendor.b61eec3b.js.map